...
proc = CoreNLP(configdict={'annotators': 'tokenize,ssplit,pos,depparse,lemma,ner','depparse.model': 'edu/stanford/nlp/models/parser/nndep/english_SD.gz'}, corenlp_jars=["/usr/local/lib/stanford-corenlp-full-2017-06-09/*"])
import pdb
#pdb.set_trace()
